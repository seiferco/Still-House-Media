        ...
        >
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto px-6 py-6 custom-scrollbar">
                    <div className="text-base text-[#1A365D]/80 leading-relaxed whitespace-pre-line">
                        {content}
                    </div>
                </div>
            </motion.div>
...
export default function ThingsToKnow({ property }) {
    ...
    return (
        <section id="things-to-know" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16">
            <div className="mb-8">
                <h2 className="text-3xl md:text-4xl font-semibold text-[#1A365D]">Things to know</h2>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 md:gap-12">
                ...
                <div className="flex flex-col">
                    <div className="flex items-center gap-3 mb-4">
                        <CalendarX size={24} className="text-[#1A365D]" />
                        <h3 className="text-xl font-semibold text-[#1A365D]">{cancellation.title}</h3>
                    </div>
                    <div className="text-[#1A365D]/80 leading-relaxed mb-4">
                        <p>{cancellation.description}</p>
                    </div>
                    <button
                        onClick={() => openModal('cancellation')}
                        className="flex items-center gap-1 font-semibold text-[#1A365D] underline hover:text-[#0077B6] transition-colors mt-auto w-fit"
                    >
                ...
                <div className="flex flex-col">
                    <div className="flex items-center gap-3 mb-4">
                        <Key size={24} className="text-[#1A365D]" />
                        <h3 className="text-xl font-semibold text-[#1A365D]">House rules</h3>
                    </div>
                    <ul className="text-[#1A365D]/80 leading-relaxed space-y-2 mb-4">
                ...
                <div className="flex flex-col">
                    <div className="flex items-center gap-3 mb-4">
                        <Shield size={24} className="text-[#1A365D]" />
                        <h3 className="text-xl font-semibold text-[#1A365D]">Safety & property</h3>
                    </div>
                    <ul className="text-[#1A365D]/80 leading-relaxed space-y-2 mb-4">
